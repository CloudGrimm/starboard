...
// TODO Bring versionInfo stuct here
...
func GetDefaultConfig() ConfigData {
	return map[string]string{
		...
		"trivy.imageRef":      "docker.io/aquasec/trivy:0.11.0",
...
func (c ConfigData) GetTrivyImageRef() string {
	...
	return "docker.io/aquasec/trivy:0.11.0"
}
...
func (c *configReader) Read(ctx context.Context) (ConfigData, error) {
	// TODO Use constants for ns and configmap
	cm, err := c.client.CoreV1().ConfigMaps("starboard").Get(ctx, "starboard", metav1.GetOptions{})
	if err != nil {
		return nil, err
	}
	return cm.Data, nil
...
// TOOD move constants somewhere so we don't have cycles
